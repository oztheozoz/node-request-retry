...
describe('Request attempts', function () {
  ...
  it('should call delay strategy 2 times after some retries', function (done) {
    var mockDelayStrategy = sinon.stub().returns(100);
    ...
    request({
      ...
      // If mockDelayStrategy returns 1ms, timeDiff would be ~560ms. Since it returns 100ms, we expect the timeDiff to be between 700 and 800 inclusive.
      t.isTrue(timeDiff >= 700 && timeDiff <= 800, 'delayStrategy\'s return value was not used or was used incorrectly');
